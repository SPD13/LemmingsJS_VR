...
and gadgets: jumper, shimmier, slider, laserer, portals), the minimap
in both panels (`Doc/MINIMAP_PLAN.md`) and NeoLemmix's replay, frame-skip
and directional-select buttons with its saved states
(`Doc/REPLAY_PLAN.md`). Nothing from the
